...
## .最简单的 @Entry 宏说明 - @Entry SwiftUI Environment Macro - https://www.youtube.com/watch?v=n0oN4PSB0Y0
## .使用 @Entry 简化自定义环境 - SwiftUI Entry Macros: The Easiest Way to Make Your Code Look Pro - https://www.youtube.com/watch?v=_SDytQat-iU&t=19s
## .使用 @Bindable 绑定环境变量 - You’re Using @Environment WRONG in SwiftUI! Here’s the Right Way - https://www.youtube.com/watch?v=MytBtixkMS0
## .@Entry 宏简化说明 - Create Environment Objects in One Line Using SwiftUI’s Entry Macro - https://www.youtube.com/watch?v=d976O4pIX9s
## .@Entry 宏简化说明 - Don't write this code! (use the @Entry macro instead 😌) - https://www.youtube.com/watch?v=kmigO5TSlDY
## .@Entry 宏也支持计算属性 - Adding keys to SwiftUI's environment with Xcode 16 and @Entry - https://www.youtube.com/watch?v=a90IYC8rxcY&t=9s
## .iOS 17 以及之前的兼容性处理 - How to Use @Environment & @EnvironmentObject in 2025 - https://www.youtube.com/watch?v=5enyOSqkL-w
## .苹果官方文档讲解 - What's New in SwiftUI State Management - https://www.youtube.com/watch?v=Pe7RMWrQlZw
