...
public final class SwiftSignposter: NSObject {
    ...
    public func signpostNetworkGetBeginWith(url: String, timeAndURLStamp: NSString) {
        let signpostID = OSSignpostID(log: Log.NetWork, object: timeAndURLStamp)
    ...
    public func signpostPerformanceBeginWith(id: UInt64) {
        os_signpost(.begin, log: Log.Performance, name: "性能路标持续事件跟踪", signpostID: OSSignpostID(id), "ID%{public}s", "\(id)")
    }

    public func signpostPerformanceEndWith(id: UInt64) {
        os_signpost(.end, log: Log.Performance, name: "性能路标持续事件跟踪", signpostID: OSSignpostID(id), "ID%{public}s", "\(id)")
    }
    ...
    public func signpostBeginWith(id: UInt64) {
        os_signpost(.begin, log: Log.PointsOfInterest, name: "自定义路标持续事件跟踪", signpostID: OSSignpostID(id), "ID%{public}s", "\(id)")
    }

    public func signpostEndWith(id: UInt64) {
        os_signpost(.end, log: Log.PointsOfInterest, name: "自定义路标持续事件跟踪", signpostID: OSSignpostID(id), "ID%{public}s", "\(id)")
    }
    ...
    public func signpostFlashEventWith(id: UInt64) {
        os_signpost(.event, log: Log.PointsOfInterest, name: "自定义路标瞬时事件发生", signpostID: OSSignpostID(id), "ID%{public}s", "\(id)")
    }
}
